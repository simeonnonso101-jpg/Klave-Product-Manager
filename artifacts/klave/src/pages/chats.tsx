        ...
        <div className="flex-1 overflow-y-auto bg-card">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center h-[60vh] text-center px-6">
              ...
              <p className="text-muted-foreground mb-6">Create a real estate masterclass or join an existing property investing group.</p>
              <Link href="/groups/new" className="text-primary font-semibold hover:underline">
                Create a new class
              </Link>
            </div>
          ) : (
