...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-[100dvh] bg-background text-foreground overflow-hidden">
      ...
      <main className="relative max-w-6xl mx-auto px-4 sm:px-6 md:px-10 pt-8 sm:pt-12 md:pt-20 pb-24">
        {/* Hero */}
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              ...
              <Link href="/sign-in" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto rounded-full px-7 h-12 text-base font-semibold border-border bg-card/60"
                >
          ...
          <div className="relative">
            ...
            <div className="relative bg-card text-card-foreground rounded-[2rem] shadow-2xl border border-border p-6 space-y-4">
              <div className="flex items-center gap-3 pb-3 border-b border-border">
                ...
                <div>
                  <div className="font-semibold text-foreground">Productivity Mastery</div>
                  <div className="text-xs text-muted-foreground">142 members</div>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex">
                  <div className="max-w-[80%] bg-muted rounded-2xl rounded-tl-sm px-4 py-2.5 text-sm text-foreground">
        ...
        {/* Stats strip */}
        <div className="mt-20 sm:mt-24 grid grid-cols-3 gap-3 sm:gap-6 bg-card/80 backdrop-blur rounded-2xl sm:rounded-3xl border border-border shadow-sm p-5 sm:p-8">
          {[
            ...
            <div key={s.label} className="text-center">
              ...
              <div className="text-[11px] sm:text-sm text-muted-foreground mt-0.5">{s.label}</div>
            </div>
          ))}
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-20 sm:mt-24">
          {[
            ...
            <div
              key={f.title}
              className="bg-card/90 backdrop-blur rounded-2xl p-6 border border-border shadow-sm hover:shadow-md transition-shadow"
            >
        ...
        <section className="mt-20 sm:mt-28">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {TESTIMONIALS.map((t) => (
              <div
                key={t.name}
                className="bg-card text-card-foreground rounded-2xl p-6 border border-border shadow-sm flex flex-col"
              >
          ...
          <div className="space-y-3">
            {FAQS.map((f, i) => (
              <button
                ...
                className="w-full text-left bg-card border border-border rounded-2xl px-5 py-4 sm:px-6 sm:py-5 hover:border-[#5A1DE6]/40 transition-colors"
              >
                ...
                {openFaq === i && (
                  <p className="text-sm sm:text-[15px] text-muted-foreground leading-relaxed mt-3 pr-8">{f.a}</p>
                )}
              </button>
            ))}
          </div>
